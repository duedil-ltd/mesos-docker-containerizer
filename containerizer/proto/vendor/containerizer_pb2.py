# Copy of the containerizer proto from mesos.interface=0.20.1, with hacked
# `import mesos_pb2`. Vendored in because of
# https://issues.apache.org/jira/browse/MESOS-2028
